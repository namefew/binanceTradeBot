...
class CommodityChannelIndexStrategy(BaseStrategy):
    """
    商品通道指数策略 (CCI)
    识别统计异常的价格波动
    """
    ...
    def __init__(self, period=20, overbought=100, oversold=-100, transaction_cost=0.001, position_size=1.0):
        super().__init__("Commodity Channel Index Strategy", transaction_cost, indicator_short_name="CCI", position_size=position_size)
        self.period = period
